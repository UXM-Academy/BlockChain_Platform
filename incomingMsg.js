...
var IncomingMsg = function (_React$Component) {
  ...
  function IncomingMsg(props) {
    _classCallCheck(this, IncomingMsg);

    // 파일 cid 다운 받기를 누르면 읽기(필요가 있을때 복호화)
    // content(메시지) cid 바로 읽기(복호화)
    // author: 판매자 id
    // prev: cid
    var _this = _possibleConstructorReturn(this, (IncomingMsg.__proto__ || Object.getPrototypeOf(IncomingMsg)).call(this, props));
