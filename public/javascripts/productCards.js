    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "card-body" },
          React.createElement("h5", { className: "card-title" }, product.title),
          React.createElement(
            "p",
            { className: "card-text" },
            product.explanation
          ),
          React.createElement("h6", null, product.price + "WON")
        )
      )
    )
  );
...
var ProductCards = (function (_React$Component) {
  ...
  function ProductCards(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (ProductCards.__proto__ || Object.getPrototypeOf(ProductCards)).call(
        this,
        props
      )
    );
...
domContainer.addEventListener(
  ...
  function (e) {
    console.log(e);
    ReactDOM.render(
      React.createElement(ProductCards, { products: products }),
      e.target
    );
  },
  false
